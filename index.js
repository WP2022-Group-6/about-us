...
let moveElements = [{
    elementID: 'home_cat', item: document.getElementById("home_cat"), offset: [0, 0], originOffset: ['20%', '72.5%'], isDown: false, name: '王宣雅', trait: ['貓', '睡覺', '吃'], job: 'Engineer', url: 'image/hsuanya.png',
    content: '讀電機三年還是不知道學了什麼，是個每天三點都還沒睡但是從來沒辦法把書讀完的時間殺手，唯一的特長是如果沒人叫我起床的話我可以睡一整天。'
},
{
    elementID: 'home_freedom', item: document.getElementById("home_freedom"), offset: [0, 0], originOffset: ['15%', '45%'], isDown: false, name: '傅約榮', trait: ['自由奔放', '及時行樂', '天馬行空'], job: 'Engineer', url: 'image/MikazukiHikari.png',
    content: '我是電機大三的傅約榮，興趣是認識各種人、旅行、還有參加各種奇怪的社團，立志成為交際廣闊，遊歷四方的宅宅。「人生是一場嘉年華，讓自己每一個當下都活得有意義，讓人生的每個節點都過得有價值。」'
},
{
    elementID: 'home_meme', item: document.getElementById("home_meme"), offset: [0, 0], originOffset: ['25%', '17.5%'], isDown: false, name: '馬心慈', trait: ['梗圖', '睡覺', '刮刮樂'], job: 'Designer', url: 'image/mamamaxinz.png',
    content: '讀心理四年還是沒辦法知道你在想什麼。\n每個月都要買刮刮樂！財富自由靠這次。\n當你聯絡不到我的時候都在睡覺。'
},
{
    elementID: 'home_liver', item: document.getElementById("home_liver"), offset: [0, 0], originOffset: ['70%', '20%'], isDown: false, name: '張仁謙', trait: ['爆肝', 'coding', '追求完美'], job: 'Engineer', url: 'image/Jench2103.png',
    content: '我是電機系三年級的張仁謙，對於程式開發、系統設計等議題有莫名的熱衷，期許自己可以追求 stay hungry, stay foolish 的精神，並善用所學解決生活問題，盡工程師的本分、追求工程的卓越！'
},
{
    elementID: 'home_workhard', item: document.getElementById("home_workhard"), offset: [0, 0], originOffset: ['80%', '50%'], isDown: false, name: '謝亞城', trait: ['認真', '開朗', '吃'], job: 'Engineer', url: 'image/JeffYaCheng.png',
...
moveElements.forEach(function (moveElement) {
    ...
    moveElement['item'].addEventListener('mouseup', function () {
        ...
        if (movedPos['right'] >= bowlPos['left'] && movedPos['bottom'] >= bowlPos['top'] && movedPos['left'] <= bowlPos['right'] && movedPos['top'] <= bowlPos['bottom']) {
            ...
            $('#person-base-img').attr('src', moveElement['url'])
...
$('#person-base-icon').click(async function () {
    moveElements.forEach(function (moveElement) {
